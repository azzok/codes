    ...
    <td valign="top" align="center"><table class="em_main_table" style="width:700px;" width="700" cellspacing="0" cellpadding="0" border="0" align="center">
        ...
        <tbody><tr>
          <td style="padding:15px;" class="em_padd" valign="top" bgcolor="#f6f7f8" align="center"><table width="100%" cellspacing="0" cellpadding="0" border="0" align="center">
              <tbody><tr>
                <td style="font-family: Arial, sans-serif; font-size:12px; line-height:15px; color:#0d1121;" valign="top" align="center"><b>Manimegalai Enterprises Enquiry Mail </b></td>
              </tr>
            </tbody></table></td>
        </tr>
        ...
        <tr>
          <td style="padding: 10px;" class="em_padd" valign="top" bgcolor="#f6f7f8" align="left"><table width="50%" style="padding:10px;" cellspacing="0" cellpadding="0" border="1" align="center">
              ...
              <tr>
                <td style="font-family: Arial, sans-serif; font-size:14px; line-height:18px; color:#999999;padding:10px;" valign="top" align="left">First Name</td><td style="font-family: Arial, sans-serif; font-size:14px; line-height:18px; color:#999999;padding:10px" valign="top" align="left">'.$fname.'</td>
              </tr>
 
                <tr>
                <td style="font-family: Arial, sans-serif; font-size:14px; line-height:18px; color:#999999;padding:10px;" valign="top" align="left">Last Name</td><td style="font-family: Arial, sans-serif; font-size:14px; line-height:18px; color:#999999;padding:10px" valign="top" align="left">'.$lname.'</td>
              </tr>
               <tr>
                <td style="font-family: Arial, sans-serif; font-size:14px; line-height:18px; color:#999999;padding:10px;" valign="top" align="left">Email</td><td style="font-family: Arial, sans-serif; font-size:14px; line-height:18px; color:#999999;padding:10px;" valign="top" align="left">'.$mail.'</td>
              </tr>
        ...
        <tr>
          <td style="padding:38px 30px;" class="em_padd" valign="top" bgcolor="#f6f7f8" align="center"><table width="100%" cellspacing="0" cellpadding="0" border="0" align="center">
              ...
              <tr>
                <td style="font-family:"Open Sans", Arial, sans-serif; font-size:11px; line-height:18px; color:#999999;" valign="top" align="center"><br>Manimegalai Enterprises © 2019 Companyname. All Rights Reserved. </td>
              </tr>
            </tbody></table>
            </td>
        </tr>
...
try {
    ...
    $mail->Password = 'l?gB}L6nOsS_';                           // SMTP password
    $mail->SMTPSecure = 'tls';                            // Enable TLS encryption, `ssl` also accepted
    $mail->Port = 587;                                    // TCP port to connect to

    //Recipients
    $mail->setFrom('admin@manimegalaienterprises.com', 'Manimegalai Enterprises');
    //$mail->addAddress('azzok17@gmail.com', 'Joe User');     // Add a recipient
    $mail->addAddress('mmtataphotonplus@gmail.com');   // Name is optional
    $mail->addReplyTo('mmtataphotonplus@gmail.com', 'Information');
    //$mail->addCC('azzok17@gmail.com');
    //$mail->addBCC('azzok17@gmail.com');

    //Attachments
    // $mail->addAttachment('/var/tmp/file.tar.gz');         // Add attachments
    //$mail->addAttachment('C:/Users/user/Desktop/admin_image/my_admin.png', 'new.jpg');    // Optional name
    //$mail->addAttachment('C:/Users/user/Desktop/admin_image/images.jpg', 'new2.jpg');    // Optional name

    //Content
    $mail->isHTML(true);                                  // Set email format to HTML
    $mail->Subject = 'Manimegalai Enterprises Enquiry Mail';
    $mail->Body    = $megContent;
