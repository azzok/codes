    ...
    <td valign="top" align="center"><table class="em_main_table" style="width:700px;" width="700" cellspacing="0" cellpadding="0" border="0" align="center">
        ...
        <tbody><tr>
          <td style="padding:15px;" class="em_padd" valign="top" bgcolor="#f6f7f8" align="center"><table width="100%" cellspacing="0" cellpadding="0" border="0" align="center">
              <tbody><tr>
                <td style="font-family: Arial, sans-serif; font-size:12px; line-height:15px; color:#0d1121;" valign="top" align="center"><b> Enquiry Mail - Fiber Broadband Chennai </b></td>
              </tr>
            </tbody></table></td>
        </tr>
        ...
        <tr>
          <td style="padding: 10px;" class="em_padd" valign="top" bgcolor="#f6f7f8" align="left"><table width="50%" style="padding:10px;" cellspacing="0" cellpadding="0" border="1" align="center">
              ...
              <tr>
                <td style="font-family: Arial, sans-serif; font-size:14px; line-height:18px; color:#999999;padding:10px;" valign="top" align="left">Name</td><td style="font-family: Arial, sans-serif; font-size:14px; line-height:18px; color:#999999;padding:10px" valign="top" align="left">'.$clinetname.'</td>
              </tr>
             ...
             <tr>
                <td style="font-family: Arial, sans-serif; font-size:14px; line-height:18px; color:#999999;padding:10px" valign="top" align="left">Plan</td><td style="font-family:Arial, sans-serif; font-size:14px; line-height:18px; color:#999999;padding:10px;" valign="top" align="left">'.$location.'</td>
              </tr>
              <tr>
...
$mail->Host = 'mail.fiberbroadbandchennai.in';  // Specify main and backup SMTP servers

$mail->SMTPAuth = true;                               // Enable SMTP authentication
$mail->Username = 'azzok17@fiberbroadbandchennai.in';                 // SMTP username
$mail->Password = 'L6)@p@7876Uyytr';

$mail->SMTPAuth = true;                               // Enable SMTP authentication
$mail->Username = 'admin@fiberbroadbandchennai.in';                 // SMTP username
$mail->Password = 'L6)@p@H5Wzpa';
...
$mail->setFrom('admin@fiberbroadbandchennai.in', 'Fiber Broadband Chennai');
$mail->Subject = "Fiber Broadband Chennai";
$mail->MsgHTML($megContent);
$mail->addAddress('fiberbroadbandschennai@gmail.com'); // Name is optional
